...
public class DisciplinaService {
    ...
    public List<Disciplina> findAll() {return disciplinaRepository.findAll();}
    ...
    public void update(Long id, Disciplina disciplina) {
        Optional<Disciplina> disciplinaFronDb = findById(id);
        if (disciplinaFronDb.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Disciplina não encontrado");
        }

        Disciplina disciplinaUpdated = disciplinaFronDb.get();
